...
$barang = [
    ...
    ['nama' => 'Dawny', 'stok' => 15, 'harga' => 12880],
    ['nama' => 'Le Mineral', 'stok' => 25, 'harga' => 5650]
];

$transaksi = [
    ['nama' => 'Pepsodent', 'jumlah_terjual' => 2],
    ['nama' => 'Sunlight', 'jumlah_terjual' => 4],
    ['nama' => 'Baygon', 'jumlah_terjual' => 6],
    ['nama' =>'Dove', 'jumlah_terjual' => 1],
    ['nama' => 'Rinso', 'jumlah_terjual' => 3],
    ['nama' => 'Dawny', 'jumlah_terjual' => 3],
    ['nama' => 'Le Mineral', 'jumlah_terjual' => 2]
];

// Total pembelian
$total_pembelian = 0;
$diskon = 0.20; // 25% diskon
?>
